<#   
.SYNOPSIS
    Get-SPSiteGroupUsersandIBSegments.ps1 - Loops through all sites and exports all groups and users for each site.
...
$outputfile = "$env:TEMP\" + 'SPSite_GroupUsers_and_IBSegments_' + $date + '_' + "output.csv"
$log = "$env:TEMP\" + 'SPSite_GroupUsers_and_IBSegments_' + $date + '_' + "logfile.log"
